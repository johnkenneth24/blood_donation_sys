...
namespace App\Http\Livewire\BloodNegO;
...
{
    public const TEMPLATE_PATH_A = 'docx/blood-type-neg-o.docx';
    ...
    public function export()
    {
        ...
        $filename = 'blood_neg_O-' . date('Y-m-d');
    ...
    {
        return view('livewire.blood-neg-o.export');
    }
}
