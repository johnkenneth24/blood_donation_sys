...
namespace App\Http\Livewire\BloodPosAb;
...
{
    public const TEMPLATE_PATH_A = 'docx/blood-type-pos-ab.docx';
    ...
    public function export()
    {
        ...
        $filename = 'blood_pos_AB-' . date('Y-m-d');
    ...
    {
        return view('livewire.blood-pos-ab.export');
    }
}
