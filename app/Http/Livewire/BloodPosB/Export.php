...
namespace App\Http\Livewire\BloodPosB;
...
{
    public const TEMPLATE_PATH_A = 'docx/blood-type-pos-b.docx';
    ...
    public function export()
    {
        ...
        $donors = Donor::where('blood_type', 'B+')->get();
        ...
        LogActivity::addToLog('Exported Blood Type B+ records');

        $filename = 'blood_pos_B-' . date('Y-m-d');
    ...
    {
        return view('livewire.blood-pos-b.export');
    }
}
