 ...
 <body id="landing">
     ...
     <section id="login" class="container-fluid d-flex justify-content-center align-items-center">
         <div class="card mb-3 col-md-10">
             ...
             <x-success></x-success>
             <div class="card-body ">
                 <form action="{{ route('donor.pendingStore') }}" method="post" class="row g-3">
                     @csrf
                     <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                         ...
                         <input type="text" class="form-control @error('address') is-invalid @enderror"
                             name="address" required placeholder="Barangay, Municipality, Province"
                             value="{{ old('address') }}">
                         @error('address')
                             <div class="invalid-feedback">
                                 {{ $message }}
                     ...
                     <div class="col-md-6">
                         ...
                         <input type="number" name="contact_no"
                             ...
                             value="{{ old('contact_no') }}" required placeholder="0912345xxxx">
                         @error('contact_no')
                             <div class="invalid-feedback">
                                 {{ $message }}
                             </div>
         ...
         <div class="modal-dialog modal-lg modal-dialog-scrollable">
             <div class="modal-content">
                 <div class="modal-header">
                     <h1 class="modal-title fs-5" id="staticBackdropLabel">Terms And Conditions For Blood Donation
